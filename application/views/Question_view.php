<tr id="row_<?php echo $q_id; ?>">
  <div class="panel panel-default" id="panel_<?php echo $q_id; ?>">
    <div class="panel-heading" id="row_header_<?php echo $q_id; ?>"><h3><a href="#" onclick="alpha(this.id);" class="question_row" id="question_row<?php echo $q_id; ?>"><?php echo $title; ?></a></h3><a href="http://www.askandanswer.com/index.php/homepage/load_user_profile_view/<?php echo $user_name;?>"><span class="badge"><?php echo $user_name; ?></span></a></div>
