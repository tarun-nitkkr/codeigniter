        ...
        <div class="container-fluid">
         ...
         <!--  implementing AUTO search here F -->
          <div class="col-sm-3 col-md-3">
            <form class="navbar-form" role="search" action="http://www.askandanswer.com/index.php/login/search_input/" method = "POST">

            <!-- Here implementing Auto suggest -->
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Question" name="srch-term" id="tags" onclick ="solr_search(this.value)">
                <p>Suggestion:<span id="question"></span></p> 
...
<script>
  function solr_search(str)
  {
    $(document).ready(function() {
$( "#tags" ).autocomplete({
source: '/Login/search_input'
});
});
  }
